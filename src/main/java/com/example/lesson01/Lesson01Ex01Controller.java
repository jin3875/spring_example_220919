...
public class Lesson01Ex01Controller {
	...
	public @ResponseBody Map<String, Object> printMap() {
		// {"aaaa"=1111, "bbbb"=1111, "cccc"=2222, "dddd"=3333} - java의 map
		...
		// spring web starter 때문에 jackson이라는 라이브러리가 포함되어 있다.
		return map; // {"aaaa":1111,"bbbb":1111,"cccc":2222,"dddd":3333} - map을 리턴하면 JSON으로 나타난다.
	}
